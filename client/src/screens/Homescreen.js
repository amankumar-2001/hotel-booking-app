...
function Homescreen() {
  ...
  function filterByType(e) {
    ...
    if(e!=='all')
    {
      const temprooms = dublicaterooms.filter(room => room.type.toLowerCase()==e.toLowerCase())
  ...
  return (
    <div className="container">
      <div className="row mt-5 bs filter">
        ...
        <div className="col-md-3">
          <input type='text' className='form-control' placeholder='Search Rooms' value={searchkey} onChange={(e)=>{setsearchkey(e.target.value)}}
